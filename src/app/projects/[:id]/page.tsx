    ...
    return (
        <div className="p-4 md:p-7">
            ...
            <div className="flex gap-10 mt-4 pb-3 mb-4 items-center border-b-[0.1px] border-gray-800">
                <div className="text-[#3CCF91] flex items-center"><FontAwesomeIcon icon={faLink} className="w-6 h-6" />  <span>→</span><span> Live Link</span></div>
                <div className="text-[#F7AB0A] flex items-center gap-2"><FontAwesomeIcon icon={faGithub} className="w-6 h-6" /> <span> GitHub Link</span></div>
